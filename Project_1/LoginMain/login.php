...
<body>
    <center>
        ...
        if(isset($_POST['btn']))
        {
            ...
            if($dem <= 0){
                ...
                if($password != $pwd){
                    ...
                    echo "<br>" . $thongbao . " - " . "Xin hãy vào "?> <a href="http://localhost/BT_PHP/Project_1/LoginMain/Subcoding/center.php">Trang Chủ<?php
                }
            }
        }
        ...
        if(isset($_POST['reg']))
        {
            ...
            header('location:http://localhost/BT_PHP/Project_1/LoginMain/register.php');
        }
        ?>
    </center>
</body>
